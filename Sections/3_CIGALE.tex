...
\begin{table}[htbp]
    ...
    \begin{tabular}{ll}
        ...
        Dust Attenuation.   & \cite{calzetti_dust_2000} $E_{(B-V)} = 0.01, 0.05, 0.1, 0.5$, \\
                            & $1.0, 1.5$ \\
